"""
Django settings for indeed_job_scraper project.
...
SECRET_KEY = 'django-insecure-l4zk#$p$tm^_vclww2df0fc4pkd7!u46oco^g8y-3fvr$-pql6'
...
ROOT_URLCONF = 'indeed_job_scraper.urls'
...
WSGI_APPLICATION = 'indeed_job_scraper.wsgi.application'
